...
public class ConsoleScreen extends Screen {
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if(keyCode == GLFW.GLFW_KEY_ENTER) {
            ...
            ModMessages.CHANNEL.send(PacketDistributor.SERVER.noArg(), new ConsoleLineMessage(pos, getLastLine()));
    ...
    public void onClose() {
        ...
        ModMessages.CHANNEL.send(PacketDistributor.SERVER.noArg(), new dev.hyperlynx.pulsetech.feature.console.ConsolePriorLinesMessage(pos, lines, command_box.getValue()));
        super.onClose();
    }
}
