...
public class NumberEmitterBlockEntity extends PulseBlockEntity implements NumberKnower, DebuggerInfoSource {
    ...
    public void adjustNumber(int amount) {
        number = (byte) net.minecraft.util.Mth.clamp(number + amount, Byte.MIN_VALUE, Byte.MAX_VALUE);
    }
    ...
    protected void loadAdditional(CompoundTag tag) {
        ...
        EmitterModule.CODEC.decode(NbtOps.INSTANCE, tag).result().ifPresent(success -> emitter = success.getFirst());
    }
